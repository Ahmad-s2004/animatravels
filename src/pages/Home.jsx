...
const Home = () => {
  ...
  const imgSwat = './src/assets/swat.jfif';
  const imgNeelum = './src/assets/nelum.jpg'; // Filesystem name 'nelum.jpg'
  const imgHunza = './src/assets/hunza.jpg';
  const imgSkardu = './src/assets/skardu.jpg';
